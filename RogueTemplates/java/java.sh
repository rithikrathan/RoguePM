...
mkdir -p "$PROJECT_DIR/src/main/java/$PROJECT_NAME"

cat <<EOL > "$PROJECT_DIR/src/main/java/$PROJECT_NAME/App.java"
...
EOL
echo -e "${GREEN}[✔]${RESET} Created src/main/java/$PROJECT_NAME/App.java"
